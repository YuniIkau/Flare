...
public class TextSetting : MonoUtil
{
	private static Dictionary<string, string> textMaster = new Dictionary<string, string> ();
	private void Awake ()
	{
	...
	public static void GetText (string key, out string text)
	{
